		...
		<footer>
			...
			<footer class="text-white bg-secondary text-center text-lg-start ">
					...
					<div class="row my-4">
						...
						<div class="col-lg-3 col-md-6 mb-4 mb-md-0">
							...
							<div
								...
								<img src="images/Icons/mulogo.png" height="100" alt="mulogo"
									loading="lazy" />
							</div>

							<p class="text-center">Clubs in MU</p>

							<ul class="list-unstyled d-flex flex-row justify-content-center">
								<li><a class="text-white px-2"
									href="https://www.facebook.com/MITMDS"> <i
										class="fab fa-facebook-square"></i>
								</a></li>
								<li><a class="text-white px-2"
									href="https://www.instagram.com/mdsuniv/"> <i
										class="fab fa-instagram"></i>
								</a></li>
								<li><a class="text-white ps-2"
									href="https://www.youtube.com/channel/UC8dM3_tVyVU1KyRgtmA6P5A">
						...
						<!--Grid column-->
						<div class="col-lg-3 col-md-6 mb-4 mb-md-0">
							<h5 class="text-uppercase mb-4">details</h5>

							<ul class="list-unstyled">
								<li class="mb-2"><a href="#!" class="text-white"><i
										class="fas  "></i>Events</a></li>
								<li class="mb-2"><a href="#!" class="text-white"><i
										class="fas  "></i>Clubs</a></li>
								<li class="mb-2"><a href="#!" class="text-white"><i
										class=" fas "></i>Contact Us</a></li>
						...
						<div class="col-lg-3 col-md-6 mb-4 mb-md-0">
							...
							<ul class="list-unstyled">
								<li class="mb-2"><a href="#!" class="text-white"><i
										class="fas  "></i>General information</a></li>
								<li class="mb-2"><a href="#!" class="text-white"><i
										class="fas  "></i>About the shelter</a></li>
								<li class="mb-2"><a href="#!" class="text-white"><i
										class="fas  "></i>Statistic data</a></li>
						...
						<div class="col-lg-3 col-md-6 mb-4 mb-md-0">
							...
							<ul class="list-unstyled">
								<li>
									<p>
										<i class="fas fa-map-marker-alt pe-2"></i>Mandsaur University
										By Pass Square, Revas Devda Road, S.H.-31, Mandsaur (M.P)
										-458001
									</p>
								</li>
								<li>
									<p>
										<i class="fas fa-phone pe-2"></i>+91-975-212-2999
									</p>
								</li>
								<li>
									<p>
										<i class="fas fa-envelope pe-2 mb-0"></i>studentclubs@meu.edu.in
									</p>
								</li>
							</ul>
						</div>
				...
				<div class="text-center p-3"
					...
					© 2024 Copyright: <a class="text-white" href="index.jsp"> Clubs
						In MU</a>
				</div>
				<!-- Copyright -->
			</footer>
